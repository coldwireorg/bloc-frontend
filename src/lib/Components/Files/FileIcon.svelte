		...
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width={size} height={size} on:click>
			{#if icon == 'file'}
				<path
					fill-rule="evenodd"
					clip-rule="evenodd"
					d="M6 0C4.34315 0 3 1.34315 3 3V29C3 30.6569 4.34315 32 6 32H26C27.6569 32 29 30.6569 29 29V9C29 7.34315 27.6569 6 26 6C24.3431 6 23 7.34315 23 9L23 26H9L9 6H17C18.6569 6 20 4.65685 20 3C20 1.34315 18.6569 0 17 0H6Z"
					fill="#F0F6FC"
				/>
			{:else if icon == 'text'}
			...
			{:else if icon == 'table'}
				<path
					fill-rule="evenodd"
					clip-rule="evenodd"
					d="M7 29C7 30.6569 8.34315 32 10 32C11.6569 32 13 30.6569 13 29L13 13H29C30.6569 13 32 11.6569 32 10C32 8.34315 30.6569 7 29 7H13V3C13 1.34315 11.6569 0 10 0C8.34315 0 7 1.34315 7 3V7H3C1.34315 7 0 8.34315 0 10C0 11.6569 1.34315 13 3 13H7L7 29Z"
					fill="#F0F6FC"
				/>
			{:else if icon == 'image'}
				<path
			...
			{:else if icon === 'video'}
				<path
					fill-rule="evenodd"
					clip-rule="evenodd"
					d="M32 6.00342L32 26C32 26.1036 31.9948 26.2059 31.9845 26.3067C31.8309 27.8195 30.5533 29 29 29H3C1.34315 29 0 27.6569 0 26V6C0 4.55026 1.02835 3.34069 2.39539 3.06095C2.59069 3.02099 2.79289 3 3 3L29 3C30.6569 3 32 4.34315 32 6C32 6.00114 32 6.00228 32 6.00342ZM6 9L6 23L26 23L26 9L6 9Z"
					fill="#F0F6FC"
				/>
				<path
					d="M20.5 16.866C21.1667 16.4811 21.1667 15.5189 20.5 15.134L14.5 11.6699C13.8333 11.285 13 11.7661 13 12.5359L13 19.4641C13 20.2339 13.8333 20.715 14.5 20.3301L20.5 16.866Z"
					fill="#F0F6FC"
				/>
			{/if}
		</svg>
