<script>
  ...
  function getUserColor(username) {
    const colors = ['#0061FF', '#CC317C', '#009639', '#D9730D', '#DFAB01', '#0F7B6C', '#0B6E99', '#6940A5', '#AD1A72', '#E03E3E']
...
<div
class="user"
style={(border?`border-color: ${border};`:'') + `background-color: ${background ? background : getUserColor(username)};width:${size}px;height:${size}px;font-size:${size < 24?6:12}px;`}
class:shared={shared}>
  { username.length >= 1 ?
